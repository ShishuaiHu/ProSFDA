...
from prosfda.datasets.dataloaders.RIGA_dataloader import RIGA_labeled_set
from prosfda.datasets.utils.convert_csv_to_list import convert_labeled_list
from prosfda.datasets.utils.transform import source_collate_fn_tr_fda, collate_fn_ts
...
from prosfda.datasets.utils.normalize import normalize_image
...
def train(args):
    ...
    for ts_csv_path in ts_csv:
        ...
        inference('model_final.model', gpu, log_folder, patch_size, root_folder, [ts_csv_path], prompt_model_path, inference_tag)
