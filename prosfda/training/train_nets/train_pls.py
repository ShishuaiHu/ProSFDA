...
from prosfda.datasets.utils.transform import collate_fn_tr, collate_fn_ts
from prosfda.utils.lr import adjust_learning_rate
from prosfda.utils.metrics.dice import get_hard_dice
from torchvision.utils import make_grid
from prosfda.loss_functions.bn_loss import bn_loss
...
def train(args):
    ...
    for ts_csv_path in ts_csv:
        ...
        inference('model_final.model', gpu, log_folder, patch_size, root_folder, [ts_csv_path], pretrained_model_path, inference_tag)
