...
from prosfda.datasets.dataloaders.RIGA_dataloader import RIGA_labeled_set, RIGA_unlabeled_set
from prosfda.datasets.utils.convert_csv_to_list import convert_labeled_list
from prosfda.datasets.utils.transform import collate_fn_ts
from prosfda.utils.metrics.dice import get_hard_dice
from prosfda.utils.visualization import visualization_as_nii


def inference(chk_name, gpu, log_folder, patch_size, root_folder, ts_csv, pretrained_model_path, inference_tag='all'):
    ...
    model = UNet_PLS(pretrained_model_path)
    ...
    if evaluate:
        ...
        metrics_str = 'Tag: {}\n  Disc dice: {}+{}; Cup dice: {}+{}.'.format(inference_tag, disc_dice, disc_std, cup_dice, cup_std)
        print(metrics_str)
